...
@WebAppConfiguration //어플리케이션 컨텍스트의 웹 버전을 생성하는 데 사용하는 어노테이션
...
//	
	...
	void testList() throws Exception {
		ModelAndView mv = mockMvc.perform(MockMvcRequestBuilders.get("/freeboard/freeList")) // 가상의 요청을 보냄
				...
				.getModelAndView(); //요청 결과에서 ModelAndViwe 객체를 얻음.
		
		//컨트롤러에서 Model객체에 담은 데이터를 확인.
