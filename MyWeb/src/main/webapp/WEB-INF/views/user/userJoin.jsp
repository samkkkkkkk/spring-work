                    ...
                    <form action="/myweb/user/join" method="post" name="joinForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="userPhone2" type="text" class="form-control phone2" id="userPhone2" placeholder="휴대폰번호를 입력하세요.">
                            </div>
                        </div>
                        <div class="form-group email-form">
                            <label for="email">이메일</label><br>
                            <div class="input-group">
                                <input name="userEmail1" type="text" class="form-control" id="userEmail1" placeholder="이메일">
                                ...
                                <div class="input-group-addon" id="mail-check-btn">
                                    <button type="button" class="btn btn-primary">이메일인증</button>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        document.getElementById('idCheckBtn').onclick = function (){
            ...
            */
            ...
            - Promise 객체를 자동으로 리턴하여 손쉽게 통신 응답 데이터를 
            소비할 수 있게 해 줍니다.
            ...
            // fetch('url', {요청 관련 정보르 담은 객체(GET방식에서는 따로 전달 안함.)})
        ...
        document.getElementById('mail-check-btn').onclick = function() {
            ...
            fetch('/myweb/user/email', {
                method: 'post',
                headers: {
                    'Content-Type': 'text/plain' //HTML 태그까지 모두 보여주는 데이터타입
                },
                body: email
            })
            .then(res => res.text())
        ...
        document.querySelector('.mail-check-input').onblur = function(e) {
            ...
            const $resultMsg = document.getElementById('mail-check-warn'); //sapn
        ...
        pw.onkeyup = function(){
            var regex = /^[A-Za-z0-9+]{8,16}$/;
             if(regex.test(document.getElementById("userPw").value )) {
                ...
                document.getElementById("msgPw").innerHTML = "비밀번호를 제대로 입려하세요.";
                pwFlag = false;
            }
        }
