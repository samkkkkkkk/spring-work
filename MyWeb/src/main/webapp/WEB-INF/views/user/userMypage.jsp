							...
							<table class="table">
								<tbody class="m-control">
									...
									<tr>
										...
										<td><input class="form-control input-sm" name="userEmail1" value="${userInfo.userEmail1}"> <select
									...
									<tr>
										...
										</select> <input class="form-control input-sm" name="userPhone2" value="${userInfo.userPhone2}"></td>
									</tr>
									<tr>
