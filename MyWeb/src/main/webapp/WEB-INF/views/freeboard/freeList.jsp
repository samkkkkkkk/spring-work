...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>  
    ...
    <section>
        <div class="container-fluid">
            ...
            <form action="/myweb/freeboard/freeList">
		    		<div class="search-wrap">
                       ...
                       <select name="condition" class="form-control search-select">
                            ...
                            <option value="content" ${pc.page.condition ==  'condition' ?'selected' : ''}>내용</option>
		    ...
		    <form action="/myweb/freeboard/freeList" name="pageForm">
                    ...
                    <hr>
                    <ul id="pagenation" class="pagination pagination-sm">
                    	<c:if test="${pc.prev}">
                    ...
                    <input type="hidden" name="conditon" value="${pc.page.condition}">
    ...
    <script>
        ...
        window.onload= function() {
            ...
            document.getElementById('pagenation').addEventListener('click', e => {
