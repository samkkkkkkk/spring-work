            ...
            <div class="row">
                <div class="col-xs-12 col-md-9 write-wrap">
                        ...
                        <form action="/myweb/freeboard/modPage" method="post">
                            ...
                            <button type="button" class="btn btn-dark" onclick="location.href='/myweb/freeboard/freeList?pageNo=${p.pageNo}&amount=${p.amount}&keyword=${p.keyword}&conditon=${p.condition}'">목록</button>
                    </form>
                </div>
            </div>
        </div>
