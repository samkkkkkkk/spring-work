					...
					<div class="navbar">
						...
						<div class="collapse navbar-collapse" id="myNavbar">
							<ul class="nav navbar-nav">
								...
								<li><a
									href="${pageContext.request.contextPath}/freeboard/freeList">자유게시판</a></li>
								...
								<li class="dropdown"><a class="dropdown-toggle"
									...
									<ul class="dropdown-menu">
										<c:if test="${login == null}">
											<li><a
												href="${pageContext.request.contextPath}/user/userJoin"><span
										...
										<c:if test="${login != null}">
											<li><a
												href="${pageContext.request.contextPath}/user/userMypage"><span
