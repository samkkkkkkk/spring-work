...
public class WeatherService {
	...
	public void getShortTermForecast(String area1, String area2) {
		...
		try {
		    ...
		    urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=salFUtbGEYF%2FAh04v24b0SNU4nVfnpbAXUru8Ehvb9D%2BGvlchKxrkUjrLePQEvSG2PRBEOcojdeMQtfVGL4O2A%3D%3D"); /*Service Key*/
